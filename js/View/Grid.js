  ...
  define(['paper', 'R', 'Utils/Utils', 'i18next'], function(P, R, Utils, i18next) {
    ...
    Grid = (function() {
      function Grid() {
        ...
        this.continueDrawingsText = new P.PointText(this.limitCDRectangle.bottomCenter.add(0, 250));
        this.continueDrawingsText.fillColor = 'white';
        this.continueDrawingsText.content = i18next.t("N'hésitez pas à continuer les dessins existants, ou à les augmenter ;-)");
        this.continueDrawingsText.fontSize = 200;
        this.continueDrawingsText.justification = 'center';
        this.layer.addChild(this.continueDrawingsText);
        this.update();
        return;
      }
