...
(function() {
  ...
  define(['Items/Item', 'UI/Modal'], function(Item, Modal) {
    var Drawing, Link, VideoGame, Website;
    Drawing = (function(superClass) {
      ...
      Drawing.highlightStage = function(color) {
      ...
      Drawing.unhighlightStage = function() {
        var ref;
      ...
      Drawing.highlightValidity = function(item) {
        this.validatePosition(item, null, true);
      };

      Drawing.validatePosition = function(item, bounds, highlight) {
      ...
      Drawing.getLockWhichContains = function(rectangle) {
        var i, len, lock, ref;
        ref = R.locks;
      ...
      Drawing.getLocksWhichIntersect = function(rectangle) {
      ...
      function Drawing(rectangle1, data1, pk1, owner, date1, modulePk) {
      ...
      Drawing.prototype.initializeModule = function() {
        var module;
      ...
      Drawing.prototype.select = function(updateOptions) {
        ...
        if (!Drawing.__super__.select.call(this, updateOptions) || this.owner !== R.me) {
          return false;
        }
        ref = this.children();
        for (i = 0, len = ref.length; i < len; i++) {
      ...
      Drawing.prototype.askForModule = function() {
        $.ajax({
          method: "POST",
          url: "ajaxCall/",
          data: {
      ...
      Drawing.prototype.createSelectModuleModal = function(result) {};

      Drawing.prototype.addModule = function() {};
