...
(function() {
  define(['Tools/Tool', 'Tools/MoveTool', 'Tools/SelectTool', 'Tools/PathTool', 'Tools/EraserTool', 'Tools/ItemTool', 'Tools/LockTool', 'Tools/MediaTool', 'Tools/TextTool', 'Tools/ScreenshotTool', 'Tools/GradientTool', 'Tools/CarTool'], function(Tool) {
    var ToolManager;
