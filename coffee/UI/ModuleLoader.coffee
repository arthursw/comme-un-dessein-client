define ['paper', 'R', 'Utils/Utils','UI/Button', 'UI/Code'], (P, R, Utils, Button, Code) ->
    ...
    buttons = [
        ...
        # { name: 'Precise path', description: "This path offers precise controls, one can modify points along with their handles and their type.", iconURL: 'icones_icon_pen.png', classes: 'displayName', file: "Items/Paths/PrecisePaths/PrecisePath", category: undefined, favorite: true, order: 8 }
            { name: 'Precise path', iconURL: 'icones_icon_pen.png', classes: 'displayName', file: "Items/Paths/PrecisePaths/PrecisePath", category: undefined, favorite: true, order: 8 }
